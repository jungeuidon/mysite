		...
		<div id="content">
			<div id="user">
				<form:form 
					...
					<label class="block-label" for="name">이름33</label>
					...
					<img id="img-checked" src = "${pageContext.servletContext.contextPath }/assets/images/check.png" style='width:20px; display:none'>
					...
					<!--<spring:hasBindErrors name="userVo">
						...
						<p style="font-weight:bold;color:red; text-align:left; padding-left:0">
							<spring:message code='${errors.getFieldError("email").codes[0] }' text='${errors.getFieldError("email").defaultMessage }'/></p>-->
																						<!-- text: message를 설정하지 않았을경우 사용 -->
						<!--</c:if> 
					</spring:hasBindErrors>-->
